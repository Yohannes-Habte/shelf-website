...
const EditBook = ({ setOpenEditBook }) => {
  ...
  return (
    <article className="update-book-modal">
      <section className="update-book-popup-box">
        <span onClick={() => setOpenEditBook(false)} className="close-modal">
          X
        </span>
        <h2 className="update-book-form-title "> Update Book</h2>

        <form action="" className="update-book-form" onSubmit={handleSubmit}>
