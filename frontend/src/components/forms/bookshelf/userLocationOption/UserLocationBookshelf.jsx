...
import { API, cloud_name, cloud_URL, upload_preset } from "../../../../utils/security/secreteKey";
...
const UserLocationBookshelf = ({ setOpenUserLocationBookshelf }) => {
    ...
    <article className="bookshelf-modal">
      <section className="bookshelf-popup-box">
        <span
          ...
          onClick={() => setOpenUserLocationBookshelf(false)}
        >
          X
        </span>
...
export default UserLocationBookshelf;
